...
def index():
    ...
    # Adding pagination using request.args object
...
def user(username):
    ...
    # Adding pagination using the request.args object
    page = request.args.get('page', 1, type=int)
...
# Not using 'GET' method because it can be exploited in CSRF
